      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap pt-6 text-center lg:text-left">
          <div className="w-full px-4 lg:w-6/12">
            <img className="mx-auto" src={logoData[0].imgSrc}  alt="logo Ahmedaly James" />
                ...
                <ul className="mt-3">
                  ...
                  {(name === "Me contacter") ? (
                    <Typography
                      ...
                      rel="noreferrer"
                      variant="small"
                      className="break-words mb-2 block font-normal text-blue-gray-500 hover:text-blue-gray-700"
                    >
                      {item.name}
                    </Typography>
                  ) : (
